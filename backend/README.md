...
## Project Structure
    ...
    ├── tst_ejkfnejndfjedew_55920  # Django project configurations
...
1. Clone this repo and `cd tst_ejkfnejndfjedew_55920`
...
2. Clone this repo and `cd tst_ejkfnejndfjedew_55920`
